...
//IDDHAR SE GYRO KS SETUP CHALU HOTA HAI
   ...
   // join I2C bus (I2Cdev library doesn't do this automatically)
    ...
    //Serial.begin(115200);                                      //IDDHAR GYRO KA SERIAL THA JO BLUETOOTH KE SAATH ABHI JOIN KIYA HAI
...
// IDDHAR TAK GYRO KE LOOP CODE HAI ISLE AAGE SE BLUETOOTH CHALU HOGA
 yaw=ypr[0] * 180/M_PI;
 pitch=ypr[1] * 180/M_PI;
  ...
  if(byte_count)//If there are any bytes then deal with them
  {
    if(start = 1)
    {
      ...
      count1 = 220;
      serial_connection.println(String(count1));
      serial_connection.println(String(pitch1));
      count1 = 221;
      serial_connection.println(String(count1));
      serial_connection.println(String(pitch2));
      count1 = 222;
      serial_connection.println(String(count1));
      serial_connection.println(String(yaw1));
      count1 = 223;
      serial_connection.println(String(count1));
      serial_connection.println(String(yaw2));
    }
    else
    {
